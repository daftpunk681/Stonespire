...
const storyData = {
  ...
  segment1: {
    content: `<img src="image3.jpg" alt="Description de l'image"><br><br>Vous êtes un humain voleur et vous décidez de vous rendre au Village de Stonespire.`,
    choices: [
  ...
  segmentPaladin: {
    content: `<img src="imagePaladin.jpg" alt="Description de l'image"><br><br>Vous êtes un humain paladin, il n'y a que les blaireaux qui jouent paladin. Vous vous sentez honteux.`,
    choices: [
      { text: "Continuer", next: "mort" },
    ]
  },
  segmentDarkvale: {
    content: `<img src="imageDarkvale.jpg" alt="Description de l'image"><br><br>Des bandits vous abordent.`,
    choices: [
  ...
  segmentConversation: {
    content: `<img src="imageConversation.jpg" alt="Description de l'image"><br><br>Vous parlez avec ce groupe de bandit et remarquez un écusson que vous connaissez`,
    choices: [
    ...
    content: `<img src="imageStonespireNord.jpg" alt="Description de l'image"><br><br>Ils font partie bien de la guilde de Darkholden, Vous arrivez à Stonespire par la porte Nord pour rencontrer le chef de leur groupe.Vous êtes dans la maison de la guilde de Darkholden.`,
    choices: [
  ...
  segmentAttenteChef: {
    content: `<img src="imageAttenteChef.jpg" alt="Description de l'image"><br><br>Vous attendez que le chef vous reçoive. Un des garde vous demande le mot de passe`,
    choices: [
  ...
  segmentAudienceChef: {
    content: `<img src="imageAudienceChef.jpg" alt="Description de l'image"><br><br>Vous vous êtes souvenu de ce mot de passe que vous avez entendu il y a fort longtemps. Le chef vous recoit.`,
    choices: [
  ...
  segmentBravo: {
    content: `<img src="imageBravo.jpg" alt="Description de l'image"><br><br>Le chef de guilde vous reçoit et il vous propose de travailler pour lui`,
choices: [
...
segmentMission: {
    content: `<img src="imageMission.jpg" alt="Description de l'image"><br><br>Il vous demande de retrouver sa fille qui a disparu, il pense qu'on pourra vous renseigner à la taverne`,
    choices: [
  ...
  segmentDrownedWitch: {
    content: `<img src="imageDrownedWitch.jpg" alt="Description de l'image"><br><br>Un noyeur gris vous attaque.`,
    choices: [
  ...
  segmentFuite: {
    content: `<img src="imageFuite.jpg" alt="Description de l'image"><br><br>Vous arrivez à Stonespire par la porte Sud. Qui n'est pas gardée`,
choices: [
...
segmentMarché: {
    content: `<img src="imageMarché.jpg" alt="Description de l'image"><br><br>Vous arrivez au marché de Stonespire`,
choices: [
...
segmentTaverne: {
    content: `<img src="imageTaverne.jpg" alt="Description de l'image"><br><br>Vous arrivez à la taverne de Stonespire`,
choices: [
  ...
  segmentAttaqueGoule: {
    content: `<img src="imageAttaqueGoule.jpg" alt="Description de l'image"><br><br>Vous attaquez le noyeur.`,
    choices: [
  ...
  segmentAttaqueGouleDague: {
    content: `<img src="imageAttaqueGouleDague.jpg" alt="Description de l'image"><br><br>Vous lui plantez votre dague.`,
    choices: [
...
segmentGoulemorte: {
    content: `<img src="imageGoulemorte.jpg" alt="Description de l'image"><br><br>La goule est morte et vous trouvez un papier et une fiole verte sur son corps`,
    choices: [
  ...
  segmentPorteEst: {
    content: `<img src="imagePorteEst.jpg" alt="Description de l'image"><br><br>Vous arrivez à Stonespire par la porte Est. Elle est lourdement gardée et les gardes zélés vous demandent un laissez-passer`,
choices: [
  ...
  mort: {
    content: `<img src="imageMort.jpg" alt="Description de l'image"><br><br>Vous êtes mort.`,
choices: [
